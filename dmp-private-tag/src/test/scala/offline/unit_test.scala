...
object unit_test {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val model = RandomForestModel.load(sc, pwd + "finalmodel")
        ...
        write2file(sb, pwd + "importance_finalmodel.csv")
        ...
        write2file(sb, pwd + "proba_" + mode + "_all_finalmodel.csv")
        ...
        write2file(sb, pwd + "similarity_" + mode + "_all_finalmodel.csv")
        sb = null
    }
